...
/*!*************************************!*\
  ...
  \*************************************/
/*! no static exports found */function(e,t){var n={width:18,height:22},o={x:59.9375165,y:30.3226474},i=16,r={android:function(){return navigator.userAgent.match(/Android/i)},blackBerry:function(){return navigator.userAgent.match(/BlackBerry/i)},iOS:function(){return navigator.userAgent.match(/iPhone|iPad|iPod/i)},opera:function(){return navigator.userAgent.match(/Opera Mini/i)},windows:function(){return navigator.userAgent.match(/IEMobile/i)},any:function(){return r.android()||r.blackBerry()||r.iOS()||r.opera()||r.windows()}},a=function(){var e=new ymaps.Map("map",{center:[o.x,o.y],zoom:i},{searchControlProvider:"yandex#search"}),t=new ymaps.Placemark(e.getCenter(),{hintContent:"Собственный значок метки",balloonContent:"г. Санкт Петербург, ул. Большая Конюшенная, 19/8'"},{iconLayout:"default#image",iconImageHref:"img/svg/map_pin.svg",iconImageSize:[n.width,n.height],iconImageOffset:[-n.width/2,-n.height]});e.geoObjects.add(t),r.any()&&e.behaviors.disable("drag")};setTimeout((function(){var e=document.createElement("script");e.src="https://api-maps.yandex.ru/2.1/?lang=ru_RU&amp;apikey=7c7d3ac5-a476-47ae-a0ab-fd6f1a9a9daa",e.type="text/javascript",document.querySelector("body").appendChild(e),e.onload=function(){return ymaps.ready(a)}}),500)}});