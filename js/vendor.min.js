...
/*!*************************************!*\
  ...
  \*************************************/
/*! no static exports found */function(e,t){var n={width:18,height:22},o={x:59.9375165,y:30.3226474},i=16;ymaps.ready((function(){var e=new ymaps.Map("map",{center:[o.x,o.y],zoom:i},{searchControlProvider:"yandex#search"}),t=new ymaps.Placemark(e.getCenter(),{hintContent:"Собственный значок метки",balloonContent:"г. Санкт Петербург, ул. Большая Конюшенная, 19/8'"},{iconLayout:"default#image",iconImageHref:"img/svg/map_pin.svg",iconImageSize:[n.width,n.height],iconImageOffset:[-n.width/2,-n.height]});e.geoObjects.add(t)}))}});