...
/* harmony import */ var _modules_mobile_menu_mobile_menu_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/mobile-menu/mobile-menu.js */ "./js/modules/mobile-menu/mobile-menu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var mobileMenu = new _modules_mobile_menu_mobile_menu_js__WEBPACK_IMPORTED_MODULE_5__["MobileMenu"]();
  mobileMenu.init();
...
var MobileMenu = /*#__PURE__*/function () {
  ...
  _createClass(MobileMenu, [{
    ...
    value: function _onWindowResize() {
      var _this = this;
      var breakpointExpansion = window.matchMedia('(min-width:767px)');
      var breakpointShrinkage = window.matchMedia('(max-width:767px)');
      var breakpointChecker = function breakpointChecker() {
        if (breakpointExpansion.matches) {
          _this._logo.style.color = logoColors.white;
          _this._mobileMenu.insertBefore(_this._logo, _this._mobileMenu.firstChild);
        }
